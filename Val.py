...
parser.add_argument(
    ...
    type=str,
    default=
    '/home/vincent/Downloads/Task01_BrainTumour/sliced_dataset/fv3/Test/',
...
parser.add_argument(
    '--output_dir',
    default=
    '/home/vincent/Downloads/Task01_BrainTumour/sliced_dataset/fv3/out/',
    type=str,
    help='output dir')
...
parser.add_argument(
    ...
    type=str,
    default=
    '/home/vincent/Downloads/Task01_BrainTumour/sliced_dataset/fv3/Test/out/nii/',
...
parser.add_argument(
    ...
    type=str,
    default=
    '/home/vincent/st/Swin-Unet-main/configs/swin_tiny_patch4_window7_224_lite.yaml',
    metavar="FILE",
...
if __name__ == "__main__":
    ...
    if not os.path.exists(snapshot):
        snapshot = snapshot.replace('best_model',
                                    'epoch_' + str(args.max_epochs - 1))
